...
let DatabaseService = class DatabaseService {
    ...
    deleteMovieBeforeYear(id) {
        let url = "/delmovies/" + id;
        return this.http.delete(url, httpOptions);
    }
    updateActorMovie(id) {
        let url = "/movies/" + id;
...
module.exports = __webpack_require__(/*! C:\Users\Kyle\Documents\Uni\FIT2095\Week10\movieAng\src\main.ts */"./src/main.ts");
